...
public class SchoolRunner {
    ...
    public static void main(String[] args) {
        ...
        Instructor instructor = new Instructor("Suleymen","Alptekin","Java",10001,ITDepartment.DEPARTMENT_NAME);
...
//        System.out.println("Instructor--->"+instructor);
        System.out.println("Instructor--->"+instructor.getStudentList());

        Instructor instructor1 = new Instructor("Ahmet","Bayram","Selenium",10002,ITDepartment.DEPARTMENT_NAME);
        //Student instructurList = new Student();
        //instructurList.setInstructorList();
